<template>
   ...
   <table v-if="filteredEvaluated.length!=0" id="allStaff">
    <caption><i class="fa fa-users" aria-hidden="true"></i> {{evaluationOfOtherServiceCaption_syslg}}</caption>
    <tr>
    ...
    <tr class="allStaffItem" v-for="i in filteredEvaluated" :key="i.matriculePerso">
      ...
      <td class="evaluateTd">
  <button  class="allStaffBtn"
   type="button" @click="elemToFind=i ;$store.commit('setMatriculeEvaluated',i.matriculePerso);evaluatePerso()">
...
export default {
    ...
    data(){
        ...
        divChangeLanguage:false,
          ...
          //language
          evaluationOfOtherServiceCaption_syslg:"",
          nameth_syslg:"",
                  prenomth_syslg:"",
                  serviceTh_syslg:"",
                  evaluationTh_syslg:"",
...
shiftLanguage(){
  if(this.$store.state.languageSys=="french"){
    ...
    this.evaluationOfOtherServiceCaption_syslg="Liste des personnels d'autre services"
    this.nameth_syslg="Nom"
                  this.prenomth_syslg="Prenom"
                  this.serviceTh_syslg="Service"
                  this.evaluationTh_syslg="Evaluation"
                  this.btn="Evaluer"  
                  this.infoBull="Vous n'avez pas encore d'autre service à evaluer"

  }else if(this.$store.state.languageSys=="english"){

    this.evaluationOfOtherServiceCaption_syslg="List of staffs of other services"
    this.nameth_syslg="Name"
            this.prenomth_syslg="Last name"
            this.serviceTh_syslg="Service"
            this.evaluationTh_syslg="Evaluation"
            this.btn="Evaluate"
            this.infoBull="You don't have any other branch to evaluate yet"

  }else{

    this.evaluationOfOtherServiceCaption_syslg="Listr'ireo mpiasa anaty servisy hafa"
    this.nameth_syslg="Anarana"
          ...
          this.btn="Hanombana"
          this.infoBull="Tsy mbola manana servisy hafa tokony hotombanana ianao"
      ...
      logout(){
        ...
        displayEvaluated(){
            var formData=new FormData();
                formData.append('action',"fetchEvaluated");
